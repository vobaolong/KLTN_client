        ...
        <hr className='res-hide-lg' /> */}
				...
				{user.role === 'user' && (
					<li className='nav-item'>
						<Link
							...
							className={`nav-link cus-sidebar-item ripple link-dark ${path === 'storeManager' ? 'active' : ''
								}`}
						>
				...
				<li className='nav-item'>
					<Link
						...
						className={`nav-link cus-sidebar-item ripple link-dark ${path === 'following' ? 'active' : ''
							}`}
					>
