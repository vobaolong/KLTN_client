...
const MainNav = ({ navFor = 'user' }) => {
	...
	return (
		<header
			className={`d-flex flex-column align-items-center justify-content-center main-nav cus-nav navbar fixed-top navbar-expand-md navbar-dark ${navFor !== 'user' && getToken().role === 'admin'
