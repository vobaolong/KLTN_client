            ...
            <small className='cus-tooltip-msg'>
              Manager: {user.firstName + ' ' + user.lastName}
				...
				<li className='nav-item'>
					<Link
						to={`/vendor/${store._id}`}
						className={`nav-link cus-sidebar-item cus-sidebar-item--db ripple link-dark ${path === store._id ? 'active' : ''
							}`}
						style={{ height: '48px' }}
					>
				...
				<li className='nav-item'>
					<Link
						...
						className={`nav-link cus-sidebar-item cus-sidebar-item--db ripple link-dark ${path === 'profile' ? 'active' : ''
							}`}
					>
				...
				<li className='nav-item'>
					<Link
						...
						className={`nav-link cus-sidebar-item cus-sidebar-item--db ripple link-dark ${path === 'products' ? 'active' : ''
							}`}
					>
				...
				<li className='nav-item'>
					<Link
						...
						className={`nav-link cus-sidebar-item cus-sidebar-item--db ripple link-dark ${path === 'staffs' ? 'active' : ''
							}`}
					>
				...
				<li className='nav-item'>
					<Link
						...
						className={`nav-link cus-sidebar-item cus-sidebar-item--db ripple link-dark ${path === 'orders' ? 'active' : ''
							}`}
					>
				...
				<li className='nav-item'>
					<Link
						...
						className={`nav-link cus-sidebar-item cus-sidebar-item--db ripple link-dark ${path === 'wallet' ? 'active' : ''
							}`}
					>
