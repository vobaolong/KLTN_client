				...
				<div className='collapse navbar-collapse'>
					<ul className='navbar-nav me-auto mb-2 mb-lg-0 gap-2'>
						<li className='nav-item'>
							<Link
								className={`rounded-1 hover nav-link ${path === 'collection' ? 'active link-active' : ''
									}`}
						...
						<li className='nav-item'>
							<Link
								className={`rounded-1 nav-link hover ${path === 'review&rating' ? 'active link-active' : ''
									}`}
						...
						<li className='nav-item'>
							<Link
								className={`rounded-1 hover nav-link ${path === 'about' ? 'active link-active' : ''
									}`}
