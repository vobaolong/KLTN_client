...
const FollowProductButton = ({
	...
	return (
		<div className='d-grid' style={style}>
			<span
				className={`d-flex align-items-center rounded-circle justify-content-center ${followingFlag ? 'text-danger' : 'text-secondary'
					} ${className}`}
			...
			>
				...
				{error ? (
					...
					<i
						style={{ fontSize: '17px' }}
						className={`pointer fa-heart p-2 rounded-circle shadow ${followingFlag
