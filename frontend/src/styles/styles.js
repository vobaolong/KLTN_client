const styles = {
  ...
  heading:
    "text-[27px] text-center font-[600] md:text-start font-Roboto pb-[20px]",
  section: "w-11/12 mx-auto",
  productTitle: "font-[600] text-[25px] font-Roboto text-[#333]",
  ...
  cart_button_text: "text-[#fff] font-[600] text-[16px] ",
